    ...
    public class SocketClient {
        ...
        public void list(JSONObject request) throws IOException {
            ...
            JSONObject response = new JSONObject() {
                ...
                @Override
                public Object getInt(String price) {
                    return null;
                }

                @Override
                public void put(String data, JSONObject jsonObject) {

                }

                @Override
                public void put(String status, String success) {

                }

                @Override
                public void put(String no, int no1) {
